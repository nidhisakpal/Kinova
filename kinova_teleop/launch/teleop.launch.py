"""Launch guarded teleoperation and MoveIt Servo."""
...
def launch_setup(context):
    ...
    moveit_config = MoveItConfigsBuilder(
        robot_name, package_name=config_package
    ).to_moveit_configs()
...
def generate_launch_description():
    arguments = [
        ...
        DeclareLaunchArgument(
            "robot_name", default_value="kinova_gen3_7dof_robotiq_2f_85"
        ),
        ...
        DeclareLaunchArgument("ee_frame", default_value="bracelet_link"),
        DeclareLaunchArgument(
            "servo_topic", default_value="/servo_node/delta_twist_cmds"
        ),
        DeclareLaunchArgument(
            "controller_topic",
        ...
        DeclareLaunchArgument("axis_map", default_value="x,-y,z"),
